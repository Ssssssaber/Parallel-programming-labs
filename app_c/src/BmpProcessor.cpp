...
BmpProcessor::BmpProcessor(const std::string& filename)
{
    ...
    _minimizedPixelArray.resize(_minimizedHeight * _minimizedWidth);
...
void BmpProcessor::PerformConvStep(int x, int y)
{
...
void BmpProcessor::PerformMinimizationStep(int x, int y)
{
    ...
    _minimizedPixelArray[minimY * _minimizedWidth + minimX].r = rSum;
    _minimizedPixelArray[minimY * _minimizedWidth + minimX].g = gSum;
    _minimizedPixelArray[minimY * _minimizedWidth + minimX].b = bSum;
}

void BmpProcessor::SaveFile(const std::string& filename)
{
    unsigned char* imageData = PixelArrayToImageData(_minimizedPixelArray, _minimizedWidth, _minimizedHeight, _channels);
