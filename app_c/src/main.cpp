...
int main(int argc, char* argv[]){
    ...
    {
        std::cout << "Usage: app_c.exe [--csv input.csv] [--x name] [--y name] [--K uint] [--thrCount uint] [--outSVG out.svg]";
        return EXIT_FAILURE;
    }
    ...
    std::cout << "Parameters: " << inputFilename << xColumn << yColumn << K << numThreads << outputFilename;

    CsvProcessor* processor = new CsvProcessor(inputFilename, xColumn, yColumn);
